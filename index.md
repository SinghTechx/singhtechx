...
">
  ...
  ">
    <!-- LEFT: INTRO -->
    <div style="
      background: radial-gradient(circle at top left, #0b1420, #05070a 55%);
      border-radius: 18px;
      padding: 20px 22px;
      border: 1px solid rgba(0, 255, 128, 0.15);
      box-shadow: 0 0 22px rgba(0, 255, 128, 0.08);
    ">
      <h2 style="margin: 0 0 10px; font-size: 24px; display: flex; align-items: center; gap: 6px;">
        Hi there
    ...
    ">
      ...
      ">
        ...
        <div style="
          ...
          padding:10px 11px;
          border-radius:14px;
          background: linear-gradient(130deg,#020617,#020617 60%,#0f172a);
          border:1px solid rgba(34,211,238,0.45);
          box-shadow: 0 0 14px rgba(34,211,238,0.25);
          transition: transform 0.18s ease, box-shadow 0.18s ease, border-color 0.18s ease;
        " onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 0 22px rgba(34,211,238,0.46)';this.style.borderColor='rgba(45,212,191,0.85)'"
           onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 0 14px rgba(34,211,238,0.25)';this.style.borderColor='rgba(34,211,238,0.45)'">
          <div style="font-size: 26px;">🎯</div>
          <div style="text-align:left;">
            <div style="font-size: 14px; font-weight:600; color:#67e8f9;">Offensive Security</div>
        ...
        <div style="
          ...
          padding:10px 11px;
          border-radius:14px;
          background: linear-gradient(130deg,#020617,#020617 60%,#020617);
          border:1px solid rgba(59,130,246,0.45);
          box-shadow: 0 0 14px rgba(59,130,246,0.25);
          transition: transform 0.18s ease, box-shadow 0.18s ease, border-color 0.18s ease;
        " onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 0 22px rgba(59,130,246,0.46)';this.style.borderColor='rgba(129,140,248,0.9)'"
           onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 0 14px rgba(59,130,246,0.25)';this.style.borderColor='rgba(59,130,246,0.45)'">
        ...
        <div style="
          ...
          padding:10px 11px;
          border-radius:14px;
          background: linear-gradient(130deg,#020617,#020617 60%,#022c22);
          border:1px solid rgba(74,222,128,0.45);
          box-shadow: 0 0 14px rgba(74,222,128,0.25);
          transition: transform 0.18s ease, box-shadow 0.18s ease, border-color 0.18s ease;
        " onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 0 22px rgba(74,222,128,0.46)';this.style.borderColor='rgba(190,242,100,0.95)'"
  ...
  ">
    <span style="
      ...
      font-size:11.5px;
      color:#e5e7eb;
    ">🔍 Focus: Realistic red-team style assessments</span>
    <span style="
      padding:6px 12px;
      border-radius:999px;
  ...
  <section id="security_standards" style="margin-bottom: 26px;">
    <h2 style="font-size: 20px; margin-bottom: 8px;">Security Standards & Frameworks 🛡️</h2>
  ...
  <section style="margin-bottom: 26px;">
    ...
    ">
      <div style="display:flex; flex-wrap:wrap; gap:10px;">
        <img class="badge" alt="Web Apps & APIs"
          src="https://img.shields.io/badge/Web%20Apps%20%26%20APIs-1A1F2B?style=for-the-badge&labelColor=111827&logo=googlechrome&logoColor=1E90FF">
        <img class="badge" alt="Infrastructure"
          src="https://img.shields.io/badge/Infrastructure-1A1F2B?style=for-the-badge&labelColor=111827&logo=linux&logoColor=DA1F26">
        <img class="badge" alt="Gen AI App Testing"
          src="https://img.shields.io/badge/Gen%20AI%20App%20Testing-1A1F2B?style=for-the-badge&labelColor=111827&logo=openai&logoColor=FF8C00">
        <img class="badge" alt="Thick Client Apps"
          src="https://img.shields.io/badge/Thick%20Client%20Apps-1A1F2B?style=for-the-badge&labelColor=111827&logo=windows&logoColor=5C2D91">
        <img class="badge" alt="System Build Reviews"
          src="https://img.shields.io/badge/System%20Build%20Reviews-1A1F2B?style=for-the-badge&labelColor=111827&logo=dell&logoColor=32CD32">
        <img class="badge" alt="Mobile App Testing"
          src="https://img.shields.io/badge/Mobile%20App%20Testing-1A1F2B?style=for-the-badge&labelColor=111827&logo=android&logoColor=3DDC84">
        <img class="badge" alt="System Breakout Testing"
          src="https://img.shields.io/badge/System%20Breakout%20Testing-1A1F2B?style=for-the-badge&labelColor=111827&logo=redhat&logoColor=DC143C">
        <img class="badge" alt="Cloud Config Reviews"
          src="https://img.shields.io/badge/Cloud%20Config%20Reviews-1A1F2B?style=for-the-badge&labelColor=111827&logo=cloudflare&logoColor=00BFFF">
        <img class="badge" alt="Email Phishing Testing"
          src="https://img.shields.io/badge/Email%20Phishing%20Testing-1A1F2B?style=for-the-badge&labelColor=111827&logo=maildotru&logoColor=FFD700">
        <img class="badge" alt="GitHub"
          src="https://img.shields.io/badge/GitHub-1A1F2B?style=for-the-badge&labelColor=111827&logo=github&logoColor=FFFFFF">
        <img class="badge" alt="Wireless"
          src="https://img.shields.io/badge/Wireless-1A1F2B?style=for-the-badge&labelColor=111827&logo=ubiquiti&logoColor=FFFFFF">
      </div>
    </div>
  </section>
...
- Clear reporting that developers and defenders can act on  
  ...
  <section style="margin-bottom: 26px;">
    ...
    <div style="display:flex; flex-wrap:wrap; gap:10px;">
      <img src="https://img.shields.io/badge/-OSCP-DA1F26?style=for-the-badge&logo=linux&logoColor=white" alt="OSCP" />
      <img src="https://img.shields.io/badge/-PNPT-0A66C2?style=for-the-badge&logo=hackthebox&logoColor=white" alt="PNPT" />
